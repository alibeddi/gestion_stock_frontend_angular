...
export class ClientService {
  ...
  getClients(
    ...
    if (filter) {
      ...
      if (filter.matriculeFiscale)
        params = params.set("matriculeFiscale", filter.matriculeFiscale);
      if (filter.email) params = params.set("email", filter.email);
      if (filter.secteurActivite)
        params = params.set("secteurActivite", filter.secteurActivite);
